...
private[shortenurl] case class Folders(folders: Seq[Folder])
...
private[shortenurl] case class PassThrough(code: String, referrer: String, remote_ip: String, replyTo: ActorRef)
