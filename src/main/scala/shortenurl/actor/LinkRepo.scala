...
trait LinkRepo extends Actor {
  ...
  private val userRepoTopic: String = context.system.settings.config.getString("user.repo.topic")
  private val linkRepoTopic: String = context.system.settings.config.getString("link.repo.topic")
